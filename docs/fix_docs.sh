...
cp dist/nanopub-display.min.js docs-dist/
find ./docs-dist/ -type f -exec sed -i 's/display"\/><meta name="viewport/display"\/><script type="module" src="\/nanopub-display.min.js"><\/script><link rel="icon" href="https:\/\/raw.githubusercontent.com\/Nanopublication\/nanopub-website\/9fee248bac306dcff7b1b0fb3d645ef6d5b62ba7\/static\/img\/icon.png"\/><meta name="viewport/g' {} +
