...
let NanopubDisplay = class NanopubDisplay extends s {
    ...
    render() {
      ...
      >
        ${n(this.prefixes, () => {
            ...
            ${!this.disableDisplayButton
                ? y `<div class="display-checklist" tabindex="100">
                  ...
                  >
                    ${displayIcon} ${this.showDisplayOptions ? y `Select the sections to display` : y ``}
                  </span>
        ...
        ${this.html_rdf ? y `${this.html_rdf}` : this.error ? y `${this.error}` : y `Loading...`}
      </div>
    `;
    }
};
...
const displayIcon = y `<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 -80 1000 1000">
  <path
